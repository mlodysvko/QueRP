...
Citizen.CreateThread(function()
	TriggerEvent('chat:addSuggestion', '/podnies',  'Użyj tej komendy aby podnieść osobę w pobliżu',  { { name = 'T', help = 'T' } } )
end)

AddEventHandler('onResourceStop', function(resource)
	if resource == GetCurrentResourceName() then
		TriggerEvent('chat:removeSuggestion', '/podnies')
	end
end)

RegisterNetEvent('komenda_podnies')
AddEventHandler('komenda_podnies', function()
	--ESX.ShowNotification('Podnosisz tę osobę...')
