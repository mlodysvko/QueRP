    ...
    if source == 0 then
        ...
        if xPlayer.group == 'superadmin' or xPlayer.group == 'best' or xPlayer.group == 'admin' then
            ...
            if args[1] == nil then
                ...
                if validWeatherType then
                    TriggerClientEvent('esx:showNotification', source, 'Pogoda zostałą zmieniona na: ~y~' .. string.lower(args[1]) .. "~s~.")
                    CurrentWeather = string.upper(args[1])
                    newWeatherTimer = 10
                    TriggerEvent('vSync:requestSync')
                else
    ...
    elseif source ~= 0 then
        ...
        if xPlayer.group == 'superadmin' or xPlayer.group == 'best' or xPlayer.group == 'admin' then
            if tonumber(args[1]) ~= nil and tonumber(args[2]) ~= nil then
                ...
                TriggerClientEvent('esx:showNotification', source, 'Czas został zmieniony na: ~y~' .. newtime .. "~s~!")
                TriggerEvent('vSync:requestSync')
            else
