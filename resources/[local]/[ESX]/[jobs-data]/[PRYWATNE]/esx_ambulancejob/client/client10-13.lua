...
RegisterCommand("10-13ems", function()
	ESX.TriggerServerCallback('break_10-13srp:checkjob', function(ils1)
		if ils1 == true then
			...
			ESX.ShowNotification('Nie jestes w EMS')
		end
	end)
end)
...
AddEventHandler("break_10-13srp:alert", function(source, Officer)
	if ESX.GetPlayerData().job.name == 'ambulance' then
		...
		TriggerEvent('chatMessage', '^*^7[Centrala]:', {255, 0, 0}, "^810-13 ^7- Ranny Medyk | ^3na ulicy ^7" .. Officer.Location)
		Citizen.CreateThread(function()
