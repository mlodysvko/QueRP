...
function PrzebierzSzatnia(styl)
  ...
  elseif styl == 'ubranieM1' then
    SetPedComponentVariation(GetPlayerPed(-1), 8, 89, 0, 0)   -- PODKOSZULEK
    SetPedComponentVariation(GetPlayerPed(-1), 11, 221, 0, 19)  -- TOP
    SetPedComponentVariation(GetPlayerPed(-1), 3, 42, 0, 0)   -- RĘCE
    SetPedComponentVariation(GetPlayerPed(-1), 4, 55, 0, 3)   -- SPODNIE
    SetPedComponentVariation(GetPlayerPed(-1), 6, 39, 0, 0)   -- BUTY
