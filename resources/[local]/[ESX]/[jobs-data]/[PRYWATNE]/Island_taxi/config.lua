...
Config.AuthorizedVehicles = {
	{model = 'taxipolice', label = 'Taxi'}
}

Config.Zones = {

	VehicleSpawner = {
		Pos   = {x = 890.44, y = -152.12, z = 76.94},
