...
Config.HeliZones = {
	PoliceHeliGarage = {
		Pos = {
			...
			{x = 1853.32,  y = 3713.49, z = 33.19},
			{x = -475.2,  y = 5988.54, z = 31.34},
			{x = -1096.4,  y = -832.16, z = 37.7}
		}
	}
}
...
Config.BoatZones = {
	PoliceBoatGarage = {
		Pos = {
			{x = -781.90,  y = -1496.94, z = 0.10},
			{x = 1581.14,  y = 3893.06, z = 30.25}
		}
	}
}
...
Config.HeliGarageName = "Garaż Helikoperów SAST"
...
Config.BoatGarageName = "Garaż Łodzi SAST "
...
Config.ExtraGarageName = "Dodatki do Aut"
...
Config.CarDraw3DText = "Naciśnij ~g~[E]~s~ aby otworzyć ~y~Garaż SAST~s~"			-- set your desired text here
...
Config.HeliDraw3DText = "Naciśnij ~g~[E]~s~ aby otworzyć ~y~Garaż Helikopterów SAST~s~"		-- set your desired text here
...
Config.BoatDraw3DText = "Naciśnij ~g~[E]~s~ aby otworzyć ~y~Garaż Łodzi SAST~s~"		-- set your desired text here
...
Config.ExtraDraw3DText = "NAciśnij ~g~[E]~s~ aby otworzyć ~y~Menu SAST~s~"		-- set your desired text here

-- -- Police Cars:
Config.PoliceVehicles = {
	{ model = 'panto', label = '---KADET---', price = 0 },
	{ model = 'victorialspd', label = 'Ford Crown Victoria', price = 0 },
	{ model = 'panto', label = '---OFICER---', price = 0 },
	{ model = 'explorer1', label = 'Ford Explorer', price = 0 },
	{ model = 'policeb', label = 'Motocykl Policyjny', price = 0 },
	{ model = 'panto', label = '---SIERŻANT---', price = 0 },
	{ model = 'yamaha', label = 'Yamaha', price = 0 },
	{ model = 'taurus3', label = 'Ford Taurus', price = 0 },
	{ model = 'tahoe', label = 'Chevrolet Tahoe', price = 0 },
	{ model = 'explorer2', label = 'Ford Explorer 2', price = 0 },
	{ model = 'panto', label = '---PORUCZNIK---', price = 0 },
	{ model = 'mustanglspd', label = 'Mustnag GT [EDWARD]', price = 0 },
	{ model = 'chargerlspd', label = 'Dodge Charger', price = 0 },
	{ model = 'silverado', label = 'Silverado', price = 0 },
	{ model = 'panto', label = '---KAPITAN---', price = 0 },
	{ model = 'explorerlspd', label = 'Ford Explorer 3', price = 0 },
	{ model = 'panto', label = '---UNMARKED---', price = 0 },
	{ model = 'umercedes', label = 'Mercedes E63AMG UNMARKED', price = 0 },
	{ model = 'fbi2', label = 'Chevrolet Tahoe UNMARKED', price = 0 },
	{ model = 'fbi', label = 'Dodge Charger UNMARKED', price = 0 },
	{ model = 'polschafter3', label = 'Schafter V12 UNMARKED', price = 0 },
	{ model = 'policefelon', label = 'Felon UNMARKED', price = 0 },
	{ model = 'ramdev', label = 'SANDKING UNMARKED', price = 0 },
        { model = 'pd_supra', label = 'Supra UNMARKED', price = 0 },
        { model = 'ROVER', label = 'RangRover UNMARKED', price = 0 },
	{ model = 'panto', label = '---AUTA OPERACYJNE---', price = 0 },
	{ model = 'MRAP', label = 'MRAP [S.W.A.T] [SPEC-DOA]', price = 0 },
	{ model = 'riot', label = 'RIOT [S.W.A.T] [SPEC-DOA]', price = 0 },
}

-- Police Helicopters:
Config.PoliceHelicopters = {
	{ model = 'polmav', label = 'Helikopter Policyjny', livery = 0, price = 0 }
}

-- Police Boats:
Config.PoliceBoats = {
	{ model = 'predator', label = 'Łódź Policyjna', livery = 0, price = 0 }
}
...
Config.LabelPrimaryCol = "Pierwszy"
Config.LabelSecondaryCol = "Drugi"
Config.LabelExtra = "Dodatki"
Config.LabelLivery = "Malowanie"
Config.TitlePoliceGarage = "Garaż LSPD"
...
Config.NoVehicleNearby = "Nie ma ~b~Pojazdu~s~ w pobliżu!"
Config.CarOutFromPolGar = "Wyjąłeś ~b~Pojazd~s~ z ~y~Garażu LSPD~s~!"
Config.HeliOutFromPolGar = "Wyjąłeś ~b~Helikopter~s~ z ~y~Garażu Helikopterów LSPD~s~!"
Config.BoatOutFromPolGar = "Wyjąłeś ~b~Boat~s~ z ~y~Garażu Łodzi LSPD~s~!"
Config.VehRepNotify = "Twój ~b~Pojazd~s~ jest ~y~Naprawiany~s~, proszę poczekać!"
Config.VehRepDoneNotify = "Twój ~b~Pojazd~s~ został ~y~Naprawiony~s~!"
Config.VehCleanNotify = "Twój ~b~Pojazd~s~ jest ~y~Czyszczony~s~, proszę poczekać!"
Config.VehCleanDoneNotify = "Twój ~b~Pojazd~s~ został ~y~Wyczyszczony~s~!"

-- ProgressBars text
Config.Progress1 = "Naprawianie Pojazdu"
Config.Progress2 = "Czyszczenie Pojazdu"

-- ProgressBar Timers, in seconds:
Config.RepairTime = 5					-- time to repair vehicle
Config.CleanTime = 3.5					-- time to clean vehicle

Config.VehicleLoadText = "Poczekaj na ~y~Pojazd~y~!"			-- text on screen when vehicle model is being loaded
