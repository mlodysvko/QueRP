...
Config.Zones = {
	...
	ls1 = {
		Pos   = { x = 822.13, y = -957.54, z = 26.03-0.90 },
	...
	ls2 = {
		Pos   = { x = 836.65, y = -969.98, z = 26.03-0.90 },
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	ls3 = {
		Pos   = { x = 837.12, y = -960.18, z = 26.03-0.90 },
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	ls4 = {
		Pos   = { x = 837.08, y = -950.66, z = 26.03-0.90 },
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	ls5 = {
		Pos   = { x = 836.8, y = -931.3, z = 26.03-0.90 },
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	ls6 = {
		Pos   = { x = 806.54, y = -931.21, z = 26.03-0.90 },
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
