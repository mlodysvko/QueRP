...
RegisterNUICallback('JEBACTUSKAKURWEFAJNYJESTEMREJESTRACJAPOSTACIHEREJSDJHASHDADASZUBIENICAPESTYCYDYBRONHEREXDDDDDDDDDKARTKYKOCHAMCIE', function(data, cb)
    ...
    if reason == "" then
        ...
        EnableGui(false)
        ESX.Scaleform.ShowFreemodeMessage('~g~QueRP.pl', 'Ustaw się w dogodnym miejscu, za 15 sekund uruchomi się menu tworzenia postaci.', 5)
        Wait(200)
        ESX.Scaleform.ShowFreemodeMessage('~g~QueRP.pl', 'Ustaw się w dogodnym miejscu, za 10 sekund uruchomi się menu tworzenia postaci.', 5)
        Wait(200)
        ESX.Scaleform.ShowFreemodeMessage('~g~QueRP.pl', 'Ustaw się w dogodnym miejscu, za 5 sekund uruchomi się menu tworzenia postaci.', 5)
        Wait(200)
        ESX.ShowAdvancedNotification('~g~QueRP.pl', nil, 'Menu tworzenia postaci zostało otworzone.', 'CustomLogo')
