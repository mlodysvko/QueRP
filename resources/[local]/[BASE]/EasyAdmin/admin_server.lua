...
Citizen.CreateThread(function()
	...
	RegisterCommand("report", function(source, args, rawCommand)
		...
		--local _source = source
		--local xPlayer = ESX.GetPlayerFromId(_source)
		--if xPlayer.group == 'superadmin' or xPlayer.group == 'admin' or xPlayer.group == 'best' or xPlayer.group == 'mod' or xPlayer.group == 'support' or xPlayer.group == 'trialsupport' then
		for i,_ in pairs(OnlineAdmins) do 
		...
		DiscordHookReport('essentialRP.pl', wiadomosc, 11750815)
		TriggerClientEvent('chatMessage', source, "^1[essential]", {255,255,255}, GetLocalisedText("admincalled"))
	
	end, false)

	function DiscordHookReport(hook,message,color)
		local gigafajnywebhook = 'https://discord.com/api/webhooks/932981338842226758/I9Qn0By6AFxeBmiLMEaniO-aGICRjbRtzrMOOpardGNCndmnF-EQAu-c6I8Csbl2j1Dt'
		local embeds = {
					{
				["title"] = message,
				["type"] = "rich",
